# -*- coding: utf-8 -*-
"""VGG16_Project_finale.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GkJRpF7YmUofXNzJTywlCnNZ8mpMcZky
"""
...
from keras.layers import Dense, Dropout, Flatten,AveragePooling2D,MaxPooling2D
...
def create_model(input_shape, n_classes, optimizer='rmsprop', fine_tune=0):
    ...
    if fine_tune > 0:
        ...
        for layer in conv_base.layers[len(conv_base.layers)-fine_tune:]:
    ...
    #top_model = AveragePooling2D(pool_size=(4, 4), strides=1, padding="same")(top_model)
    #top_model = MaxPooling2D(pool_size=(4, 4), strides=1, padding="same")(top_model)
   
    top_model = Flatten(name="flatten")(top_model)
    top_model = Dense(2064, activation='tanh')(top_model)
    top_model = Dense(1072, activation='tanh')(top_model)
...
optim_2 = RMSprop(learning_rate=0.00001)
# Re-compile the model, this time leaving the last 2 layers unfrozen for Fine-Tuning
vgg_model_ft = create_model(input_shape, n_classes, optim_2, fine_tune=10)
...
traingenplot(traingen_plot)

def plot_predictions_train(y_true, y_preds, test_generator, class_indices):
...
vgg_model_ft.load_weights('tl_model_v1.weights.best.hdf5')
...
plot_predictions(true_classes, vgg_pred_classes_ft, testgen_plot, class_indices)
...
plot_heatmap(true_classes, vgg_pred_classes_ft, class_names, ax1, title="Transfer Learning (VGG16) with Fine-Tuning")    
